    ...
    <section class="glass max-w-3xl rounded-[2rem] p-6">
      ...
      <div class="theme-panel-accent mt-6 rounded-3xl border border-dashed p-6 text-center">
        ...
        <div class="mt-4 flex flex-col justify-center gap-3 sm:flex-row">
          <button class="btn-secondary" data-action="copy-qr" type="button" ${qrActionsDisabled}>${inlineIcon({ svg: copyIcon })} Copy SVG</button>
          <button class="btn-secondary" data-action="download-qr" type="button" ${qrActionsDisabled}>${inlineIcon({ svg: downloadIcon })} Download SVG</button>
        </div>
